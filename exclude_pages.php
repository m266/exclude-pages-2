...
$myUpdateChecker = Puc_v4_Factory :: buildUpdateChecker('https://github.com/m266/exclude-pages-2', __FILE__, 'exclude-pages-2');
...
function ep_ancestor_excluded($page, $excluded_ids, $pages) {
  $parent = ep_get_page($page->post_parent, $pages); // PHP-Notice: Change "& ep_get_page" to "ep_get_page"
// Is there a parent?
  if (!$parent)
    return false;
// Is it excluded?
